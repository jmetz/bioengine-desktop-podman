...
<button
  ...
  class="border-2 relative rounded border-dustyblue-700 text-dustyblue-700 hover:bg-charcoal-800 hover:text-dustyblue-600 w-10 p-2 text-center cursor-pointer flex flex-row">
  ...
  <span
    ...
    class="absolute -top-[15px] right-0 text-dustyblue-500"
