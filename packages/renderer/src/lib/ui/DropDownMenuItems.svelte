...
<div
  ...
  class="origin-top-right absolute right-0 z-10 m-2 rounded-md shadow-lg bg-charcoal-600 ring-2 ring-blue-900 hover:ring-blue-700 divide-y divide-charcoal-600 focus:outline-none">
  <slot />
</div>
